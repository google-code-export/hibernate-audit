...
create table AUDIT_EVENT_PAIR (IS_COLLECTION char(1 char) not null, AUDIT_EVENT_PAIR_ID NUMBER(30, 0) not null, STRING_VALUE varchar2(3000 char), LIST_INDEX number(10,0), AUDIT_CLASS_FIELD_ID NUMBER(30, 0), AUDIT_EVENT_ID NUMBER(30, 0), primary key (AUDIT_EVENT_PAIR_ID));
