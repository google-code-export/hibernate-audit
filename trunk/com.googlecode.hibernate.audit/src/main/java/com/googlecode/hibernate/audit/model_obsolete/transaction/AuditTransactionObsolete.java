package com.googlecode.hibernate.audit.model_obsolete.transaction;
...
@Entity
@Table(name = "AUDIT_TRANSACTION_OBSOLETE")
@SequenceGenerator(name = "sequence", sequenceName = "AUDIT_TRANSACTION_ID_SEQ")
public class AuditTransactionObsolete {
...
*/	
	public AuditTransactionObsolete() {

        transactionTime = new Date();

    }

    public AuditTransactionObsolete(int originalTransactionIdentity) {
