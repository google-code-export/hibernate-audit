...
public class HibernateAuditHistoryAccessorsTest extends JTATransactionTest
{
    ...
    public void testGetValue_HBANotStarted() throws Exception
    {
        try
        {
            HibernateAudit.getValue("doesn't matter", "doesn't matter", "dsnmtr", 10l);
            throw new Error("should have failed");
        }
        catch(IllegalStateException e)
        {
...
//            try
//            {
//                HibernateAudit.getValue("dsntmttr", "dsnmttr", "dsntmttr", 10l);
...
//    @Test(enabled = true)
//    public void testGetValue_NoSuchEntityNameTables() throws Exception
//    {
//    }
//
//    @Test(enabled = true)
